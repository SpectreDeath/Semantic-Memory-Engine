...
export class ForensicController {
    ...
    public async analyzeEditor(editor: vscode.TextEditor) {
    ...
    private applyMarkers(editor: vscode.TextEditor, markers: any[]) {
        // Clear previous decorations
        this.decorationTypes.forEach(dt => editor.setDecorations(dt, []));

        const markerGroups = new Map<string, vscode.DecorationOptions[]>();
