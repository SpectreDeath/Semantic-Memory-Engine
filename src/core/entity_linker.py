...
class EntityLinker:
    ...
    def _link_entity(self, entity: Entity, kb_type: KnowledgeBase) -> LinkedEntity | None:
    ...
    def _link_wikipedia(self, entity: Entity) -> LinkedEntity | None:
    ...
    def _link_custom_kb(self, entity: Entity) -> LinkedEntity | None:
    ...
    def _find_similar_entity(self, entity_text: str) -> tuple[float, str | None]:
    ...
    def _get_description(self, entity: str) -> str | None:
