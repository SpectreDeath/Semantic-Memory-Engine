...
def test_forensic_entropy():
    ...
    print(
        f"[+] Normal Text Obfuscation Score: {res_normal['obfuscation_score']} (Weight: {res_normal['hamming_weight']})"
    )
    ...
    print(
        f"[+] Obfuscated Data Score: {res_obf['obfuscation_score']} (Weight: {res_obf['hamming_weight']})"
    )
