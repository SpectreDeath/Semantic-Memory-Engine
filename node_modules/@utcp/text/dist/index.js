...
// src/index.ts
import { CommunicationProtocol as CommunicationProtocol2, CallTemplateSerializer, ensureCorePluginsInitialized } from "@utcp/sdk";
...
var TextCallTemplateSerializer = class extends Serializer {
  toDict(obj) {
    return {
      name: obj.name,
...
function register(override = false) {
  ...
  CommunicationProtocol2.communicationProtocols["text"] = new TextCommunicationProtocol();
}
register();
export {
