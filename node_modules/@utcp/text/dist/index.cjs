...
__export(index_exports, {
  TextCallTemplateSchema: () => TextCallTemplateSchema,
  TextCallTemplateSerializer: () => TextCallTemplateSerializer,
  TextCommunicationProtocol: () => TextCommunicationProtocol,
  register: () => register
});
...
// src/text_call_template.ts
var import_sdk = require("@utcp/sdk");
var import_sdk2 = require("@utcp/sdk");
var TextCallTemplateSchema = external_exports.object({
  name: external_exports.string().optional(),
  call_template_type: external_exports.literal("text"),
  content: external_exports.string().describe("Direct text content of the UTCP manual or tool definitions"),
  base_url: external_exports.string().optional().describe("Optional base URL for API endpoints when converting OpenAPI specs"),
...
var TextCallTemplateSerializer = class extends import_sdk2.Serializer {
  toDict(obj) {
    return {
      name: obj.name,
...
// src/text_communication_protocol.ts
var yaml = __toESM(require("js-yaml"), 1);
var import_sdk3 = require("@utcp/sdk");
var import_http = require("@utcp/http");
var TextCommunicationProtocol = class {
  _log_info(message) {
    ...
    try {
      ...
      try {
        ...
        try {
          ...
          throw new Error(`Failed to parse content as JSON or YAML: ${jsonError.message}`);
        }
      }
      let utcpManual;
      ...
      return {
        manualCallTemplate: textCallTemplate,
        manual: new import_sdk3.UtcpManualSerializer().validateDict({ tools: [] }),
        success: false,
        errors: [errMsg]
      };
    }
...
function register(override = false) {
  (0, import_sdk4.ensureCorePluginsInitialized)();
  import_sdk4.CallTemplateSerializer.registerCallTemplate("text", new TextCallTemplateSerializer(), override);
  import_sdk4.CommunicationProtocol.communicationProtocols["text"] = new TextCommunicationProtocol();
}
register();
// Annotate the CommonJS export names for ESM import in node:
0 && (module.exports = {
  TextCallTemplateSchema,
