...
- `scripts/archive/one_off/test_scrapegraph_integration.py` - Integration test with SME infrastructure
- `scripts/archive/one_off/test_scrapegraph_simple.py` - Simple import and structure validation
