...
from src.sme.vendor.faststylometry import Corpus, burrows_delta
...
def main():
    ...
    train_corpus = Corpus()
    train_corpus.add_book(
        "Author_A",
        "Book_1",
        "The quick brown fox jumps over the lazy dog. Stylometry is the study of linguistic style.",
    )
    train_corpus.add_book(
        "Author_B",
        "Book_1",
        "Artificial intelligence and machine learning are transforming the world of digital forensics.",
    )
    ...
    comparison_data = {
        ...
        "Burrows Delta": [
            delta_results.loc["Author_A", "Unknown - Sample"],
            delta_results.loc["Author_B", "Unknown - Sample"],
        ],
