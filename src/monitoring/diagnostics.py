    ...
    def profile_gpu_fallback() -> dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "note": "Install pynvml for NVIDIA GPU monitoring",
            }
    ...
    def check_database() -> dict[str, Any]:
        ...
        try:
            ...
            health = {
                ...
                "tables": [],
                "total_records": 0,
                "db_file_size_mb": os.path.getsize(DB_PATH) / (1024**2)
            ...
            for table in tables:
                table_name = table[0]
                if not DatabaseHealthChecker._validate_table_name(table_name):
                    continue
                cursor.execute(f"SELECT COUNT(*) FROM {table_name}")
                count = cursor.fetchone()[0]

                health["tables"].append(
                    {"name": table_name, "row_count": count, "status": "active"}
                )
        ...
        try:
            ...
            efficiency = {
                "cache_metrics": {
                    ...
                    "cache_span_days": f"{result[2]} - {result[3]}"
