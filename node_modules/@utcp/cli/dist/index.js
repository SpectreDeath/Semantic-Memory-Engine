...
// src/index.ts
import { CommunicationProtocol as CommunicationProtocol2, CallTemplateSerializer } from "@utcp/sdk";
...
var CliCallTemplateSerializer = class extends Serializer {
  /**
   * REQUIRED
...
import { UtcpManualSchema, UtcpManualSerializer } from "@utcp/sdk";
...
function register(override = false) {
  ...
  CommunicationProtocol2.communicationProtocols["cli"] = new CliCommunicationProtocol();
}
register();
export {
