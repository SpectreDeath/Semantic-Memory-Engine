...
__export(index_exports, {
  FileCallTemplateSchema: () => FileCallTemplateSchema,
  FileCallTemplateSerializer: () => FileCallTemplateSerializer,
  FileCommunicationProtocol: () => FileCommunicationProtocol,
  register: () => register
});
...
// src/file_call_template.ts
var import_sdk = require("@utcp/sdk");
var import_sdk2 = require("@utcp/sdk");
var FileCallTemplateSchema = external_exports.object({
  name: external_exports.string().optional(),
  call_template_type: external_exports.literal("file"),
  file_path: external_exports.string().describe("The path to the file containing the UTCP manual or tool definitions."),
...
var FileCallTemplateSerializer = class extends import_sdk2.Serializer {
  /**
   * REQUIRED
    ...
    try {
      ...
      if (data && typeof data === "object" && (data.openapi || data.swagger || data.paths)) {
        ...
        const converter = new import_http.OpenApiConverter(data, {
          ...
          authTools: fileCallTemplate.auth_tools || void 0
        });
...
function register(override = false) {
  ...
  import_sdk4.CallTemplateSerializer.registerCallTemplate("file", new FileCallTemplateSerializer(), override);
  import_sdk4.CommunicationProtocol.communicationProtocols["file"] = new FileCommunicationProtocol();
}
register();
// Annotate the CommonJS export names for ESM import in node:
0 && (module.exports = {
  FileCallTemplateSchema,
